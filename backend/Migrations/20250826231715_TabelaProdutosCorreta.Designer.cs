...
namespace backend.Migrations
{
    ...
    [Migration("20250826231715_TabelaProdutosCorreta")]
    partial class TabelaProdutosCorreta
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUsuario = 1,
                            Admin = (short)1,
                            DateNow = new DateTimeOffset(new DateTime(2025, 8, 26, 23, 17, 15, 454, DateTimeKind.Unspecified).AddTicks(4931), new TimeSpan(0, 0, 0, 0, 0)),
